...
|--------|-------------|---------|
| **DocMgt Saved Search Metadata** | Displays record metadata for one DocMgt saved search | [Install](https://raw.githubusercontent.com/BrockDawg/Tampermonkey-Scripts/main/docmgt-record-metadata.user.js) |
